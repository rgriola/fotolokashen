          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Button
                ...
                onClick={onGpsToggle}
                className={`shadow-lg border border-border transition-colors h-12 w-12 p-0 ${
                  userLocation
              ...
              >
                <Navigation
                  className={`w-5 h-5 ${userLocation ? "fill-current" : ""}`}
                />
              </Button>
            </TooltipTrigger>
            {showTooltips && (
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Button
                ...
                className={`shadow-lg border transition-colors h-12 w-12 p-0 ${
                  showPublicLocations
              ...
              >
                <Map
                  className={`w-5 h-5 ${showPublicLocations ? "fill-current" : ""}`}
                />
              </Button>
            </TooltipTrigger>
            {showTooltips && (
          ...
          <Tooltip>
            ...
            {showTooltips && (
              <TooltipContent
                ...
                className="bg-foreground text-background border-border px-3 py-2 text-sm font-medium shadow-xl"
              >
                <p>My Spots ({savedLocationsCount})</p>
              </TooltipContent>
            )}
          </Tooltip>
          ...
          <SheetContent side="bottom" className="h-auto rounded-t-2xl">
            ...
            <div className="mt-6 space-y-3">
              ...
              >
                ...
                <div className="flex-1 text-left">
                  <div className="font-medium">My Spots</div>
                  <div className="text-xs text-muted-foreground">
                    View Locations
                  </div>
                </div>
              ...
              >
                <Map
                  className={`w-5 h-5 shrink-0 ${showPublicLocations ? "fill-current" : ""}`}
                />
                <div className="flex-1 text-left">
                  <div className="font-medium">Explore Public</div>
                  <div
                    className={`text-xs ${showPublicLocations ? "opacity-90" : "text-muted-foreground"}`}
                  >
                    {showPublicLocations
                      ? "Showing locations from all users"
                      : "Discover public locations"}
                  </div>
                </div>
                <div className="text-sm font-medium">
