            ...
            <div className="relative h-64 bg-linear-to-br from-muted to-muted/50 overflow-hidden rounded-lg">
              <Image
                ...
                onError={(e) => {
                  ...
                  if (parent) {
                    parent.innerHTML =
                      '<div class="w-full h-full flex items-center justify-center bg-linear-to-br from-primary/10 to-primary/5"><svg class="w-20 h-20 text-muted-foreground/30" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7"></path></svg></div>';
                  }
                }}
              />
            </div>
          ...
          {location.lastModifiedAt && (
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-2">
                <Calendar className="w-4 h-4 text-muted-foreground" />
                <span className="text-sm">
                  {formatDate(location.lastModifiedAt)}
                </span>
              </div>
            </div>
          )}
          ...
          {location.userSave?.savedAt && (
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-2">
                <Calendar className="w-4 h-4 text-muted-foreground" />
                <span className="text-sm">
                  {formatDate(location.userSave.savedAt)}
                </span>
              </div>
            </div>
          )}
        ...
        <AlertDialogContent className="border-destructive">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className="text-foreground">
              ...
              with all photos and data will be permanently removed. This cannot
              be undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
