        ...
        <div className="relative">
          ...
          >
            <Image
              src={photoUrl}
              alt={
                currentPhoto.caption || currentPhoto.originalFilename || "Photo"
              }
            ...
            {!showCaption && (
              <div className="absolute bottom-11 right-2 bg-black/80 backdrop-blur-sm text-white px-3 py-2 rounded-md text-xs space-y-1 max-w-xs z-10">
                ...
                {/* GPS Data */}
                {currentPhoto.hasGpsData &&
                  currentPhoto.gpsLatitude &&
                  currentPhoto.gpsLongitude && (
                    <p>
                      <span className="font-semibold">📍 GPS:</span>{" "}
                      {currentPhoto.gpsLatitude.toFixed(3)},{" "}
                      {currentPhoto.gpsLongitude.toFixed(3)}
                    </p>
                  )}
