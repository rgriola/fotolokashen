...
import { LOCATION_TYPES } from "@/lib/map-icon-colors";
    ...
    <Sheet>
      ...
      <SheetContent side="right" className="w-[320px] sm:w-95 flex flex-col">
        <SheetHeader className="pb-4">
          ...
          <SheetDescription>Customize your location view</SheetDescription>
        </SheetHeader>
        ...
        <div className="flex-1 overflow-y-auto -mx-6 px-6">
          <div className="space-y-6 py-2 ml-2.5 mr-2.5">
            ...
            <div className="space-y-3">
              ...
              >
                <Heart
                  className={`w-4 h-4 mr-2 ${favoritesOnly ? "fill-white text-white" : ""}`}
                />
