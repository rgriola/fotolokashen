...
export function PhotoLocationForm({
  ...
  const handleSubmit = useCallback(
    async (data: LocationFormData): Promise<void> => {
      if (!user) {
      ...
      try {
        ...
        console.log(
          "[PhotoLocationForm] Uploading photo via secure endpoint...",
        );
        ...
        console.log(
          "[PhotoLocationForm] Photo uploaded securely! Path:",
          secureUploadResult.upload.filePath,
        );
    ...
    [user, photoFile, photoMetadata, initialData.placeId, onSuccess],
