          ...
          <div className="flex items-center justify-between space-x-2">
            <div className="flex-1">
              ...
              <p className="text-sm text-muted-foreground mt-1">
                Receive email notifications for security alerts and important
                updates
              </p>
            </div>
            <Switch
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between space-x-2">
              ...
              <Switch
                ...
                onCheckedChange={(checked) =>
                  setGpsPermission(checked ? "granted" : "denied")
                }
                disabled={isLoading}
              />
            </div>
            <div className="bg-primary/10 dark:bg-primary/10 border border-primary/20 dark:border-primary rounded-lg p-3">
              <p className="text-xs text-primary dark:text-primary-foreground">
                <span className="font-semibold">Privacy Note:</span> Device GPS
                data is only used while the app is actively running. We never
        ...
        <CardContent className="space-y-3">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Learn how to navigate and use the map interface
              </p>
            </div>
            <Button
              variant="outline"
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Manage and organize your saved locations
              </p>
            </div>
            <Button
              variant="outline"
          ...
          <div className="flex items-center justify-between">
            <div>
              <p className="font-medium">Friends Tour</p>
              <p className="text-sm text-muted-foreground">
