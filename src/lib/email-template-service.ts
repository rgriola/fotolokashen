...
export async function createTemplate(
  ...
  const template = await prisma.emailTemplate.create({
    data: {
      ...
      brandColor: data.brandColor || '#0f172b',
      headerGradientStart: data.headerGradientStart || '#0f172b',
      headerGradientEnd: data.headerGradientEnd || '#1f2937',
      buttonColor: data.buttonColor || '#0f172b',
