...
export const EMAIL_TEMPLATES = [
  {
    value: "verification",
    label: "✉️ Verification Email",
    subject: "Confirm your email",
  },
  {
    value: "welcomeTo",
    label: "✉️ Welcome To Fotolokashen",
  ...
  },
  {
    ...
    label: "🗑️ Account Deletion Email",
...
export function generatePreviewData(user: {
  ...
  const email = user.email || "support@fotolokashen.com";
...
export function makeNonInteractive(html: string): string {
  ...
  return html
    .replace(/<a /g, '<a style="pointer-events: none; cursor: default;" ')
    .replace(
      /<button /g,
