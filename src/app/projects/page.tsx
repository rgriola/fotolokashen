        ...
        <CardContent className="text-center space-y-6 pb-8">
          <div className="bg-gradient-to-r from-primary/10 to-social/10 dark:from-primary/10 dark:to-social/10 rounded-lg p-8">
            ...
            <p className="text-muted-foreground max-w-md mx-auto">
              We're working on an exciting new feature that will allow you to
              group your saved locations into projects for better organization.
            </p>
          </div>
          ...
          <div className="pt-4">
            <p className="text-sm text-muted-foreground italic">
              💡 In the meantime, you can continue managing your locations from
              the{" "}
              <Link
                href="/locations"
