          ...
          <div className="grid gap-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Cards from /locations page - Shows Edit/Share buttons, no
                  delete
                </CardDescription>
              </CardHeader>
              <CardContent>
                {isLoading ? (
                  ...
                  <div className="text-center py-8 text-muted-foreground">
                    ...
                    <p className="text-sm">
                      Save locations on /map to see cards here
                    </p>
                  </div>
                ) : (
                    ...
                    {locations.slice(0, 6).map((location) => (
                      <LocationCard
                        ...
                        onEdit={(loc) => {
                          ...
                          setIndoorOutdoor(
                            (loc.indoorOutdoor as "indoor" | "outdoor") ||
                              "outdoor",
                          );
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Current production panels - Details (max-w-3xl), Edit & Save
                  (max-w-2xl)
                </CardDescription>
              </CardHeader>
              ...
              <CardContent className="text-sm text-primary dark:text-primary space-y-3">
                <div>
                  ...
                  <ul className="list-disc list-inside space-y-1 ml-2">
                    ...
                    <li>
                      Width: Details (max-w-3xl), Edit & Save (max-w-2xl),
                      full-width on mobile
                    </li>
                    <li>
                      Behavior: Slide from right/bottom, dismissible by swipe or
                      close button
                    </li>
              ...
              <div className="h-full">
                <LocationDetailPanel
                  ...
                  onEdit={(loc) => {
                    ...
                    setIsFavorite(loc.userSave?.isFavorite || false);
                    setIndoorOutdoor(
                      (loc.indoorOutdoor as "indoor" | "outdoor") || "outdoor",
                    );
                    setShowPhotoUpload(false);
