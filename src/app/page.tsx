        ...
        <div className="relative z-10 w-full px-4 md:px-6 lg:px-8 pt-[50px] pb-[25px]">
          <div className="mx-auto max-w-3xl text-center w-full">
            ...
            <p className="mb-8 text-lg sm:text-xl text-secondary text-center">
              Capture production locations in the field. Share your crew&apos;s
              firsthand knowledge — GPS, photos, notes, access points — so every
              team member knows exactly what worked.
            </p>
        ...
        <div className="mx-auto max-w-5xl">
          <div className="mb-12 text-center">
            ...
            <p className="text-lg text-muted-foreground">
              Turn every shoot into institutional knowledge your whole team can
              use.
            </p>
          </div>
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  See all your crew&apos;s locations at a glance. Discover
                  what&apos;s nearby before you scout.
                </CardDescription>
              </CardHeader>
            </Card>
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Log parking, access points, contacts, lighting conditions, and
                  crew setup details — attached to the exact GPS pin.
                </CardDescription>
              </CardHeader>
            </Card>
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Attach field photos with EXIF metadata preserved. Your team
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Share locations with your whole crew, specific teammates, or
                  keep them private to your account.
                </CardDescription>
              </CardHeader>
            </Card>
          </div>
