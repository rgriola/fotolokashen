      ...
      .then((data) => {
        if (data.success) {
          ...
          if (data.canVerify) {
            ...
            setMessage(
              data.message ||
                "Verification link is valid. Click confirm below.",
            );
            return;
          }
          ...
          setStatus("error");
          setMessage(
            "Unable to validate verification link. Please request a new link.",
          );
        } else {
    ...
    try {
      ...
      if (data.success) {
        ...
        if (
          ...
          (platform === "ios" && data.autoLoginToken)
        ) {
          setShouldRedirect(true);
        }
        return;
  ...
  return (
    <div className="relative min-h-screen flex items-start justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-90">
        <Image
          src="/images/landing/hero/verify-email-bg.jpg"
      ...
      <div className="relative z-10 max-w-md w-full mx-4 pt-[50px]">
        ...
        <div className="bg-white/95 backdrop-blur-sm rounded-lg shadow-xl p-8">
          ...
          {status === "ready" && (
            <div className="text-center">
              ...
              <p className="mt-2 text-muted-foreground">
                {message ||
                  "Your verification link is valid. Confirm below to finish verification."}
              </p>
              ...
              <p className="mt-4 text-xs text-muted-foreground">
                This confirmation step helps prevent automated link scanners
          ...
          {status === "no_token" && (
            <div className="text-center">
              <div
                className={`mx-auto flex items-center justify-center h-16 w-16 rounded-full ${message === "New verification email sent" ? "bg-success/10" : "bg-warning/10"}`}
              >
              ...
              <div
                className={`mt-4 p-4 rounded-lg border ${message === "New verification email sent" ? "bg-success/10 border-success/20" : "bg-warning/10 border-warning/20"}`}
              >
                {message === "New verification email sent" ? (
                  <>
                  ...
                  <>
                    ...
                    <p className="mt-2 text-sm text-warning">
                      Please check your email inbox for the confirmation link we
                      sent you during registration.
                    </p>
                  </>
                )}
              </div>
          ...
          {status === "expired" && (
            <div className="text-center">
              ...
              <div className="mt-4 p-4 bg-warning/10 border border-warning/20 rounded-lg">
                ...
                <p className="mt-2 text-sm text-warning">
                  For security reasons, email verification links expire after 30
                  minutes.
                </p>
              </div>
              <div className="mt-6 space-y-3">
              ...
              <p className="mt-4 text-xs text-muted-foreground">
                Use the "Forgot Password" flow to receive a new verification
                email.
              </p>
            </div>
          )}
          ...
          {(status === "invalid" || status === "error") && (
            <div className="text-center">
              ...
              <div className="mt-4 p-4 bg-warning/10 border border-warning/20 rounded-lg">
                ...
                <p className="mt-2 text-sm text-warning">
                  The verification link may have already been used or is no
                  longer valid.
                </p>
              </div>
              <div className="mt-6 space-y-3">
